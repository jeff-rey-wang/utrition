...
\begin{enumerate}[start=4,label={PR\arabic*.}]
	...
	\textbf{Fit Criteria:} Error message should prompt user upon failure to request 
	nutritional info regarding food items in the uploaded image.
	...
	\textbf{Fit Criteria:} Error message should prompt user upon failure to find 
	nutritional info regarding food items in the uploaded image.
	...
	\textbf{Fit Criteria:} Error message should prompt user upon failure to access 
