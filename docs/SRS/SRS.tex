...
\begin{itemize}
	\item [\FillFRNumber] The system will be able to receive text input from the user.\newline 
	\textbf{Rationale:} Users must be able to access the nutritional data of a food through typing its name.\newline
	\textbf{Priority:} High
\end{itemize}

\begin{itemize}
	\item [\FillFRNumber] The system will be able to receive vocal input from the user.\newline 
