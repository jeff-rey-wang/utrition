...
\begin{document}
	...
	\begin{enumerate}
		...
		\item{identification-accuracy-1\\}
		...
		Input/Condition: Set of images; some containing foods, others without 
		foods.
		
		Output/Result: Individual images may or may not be identified correctly.
