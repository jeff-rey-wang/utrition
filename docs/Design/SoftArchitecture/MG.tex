...
\item  [\refstepcounter{mnum} \mthemnum \label{mNL}:] Nutrition Log Module
\item  [\refstepcounter{mnum} \mthemnum \label{mFE}:] Food Entry Module
...
\item  [\refstepcounter{mnum} \mthemnum \label{mMU}:] Manual Upload Module
...
\item  [\refstepcounter{mnum} \mthemnum \label{mBC}:] Backend Communication Module
...
\item  [\refstepcounter{mnum} \mthemnum \label{mULD}:] User Log Data Structure Module
\end{description}
