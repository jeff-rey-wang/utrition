...
\item[Services:]the home page is what the user will see upon the launch of the utrition application. The user, from this home page, is able to redirect and navigate themselves to other pages such as the profile page and the upload page. 
\item[Implemented By:] [Your Program Name Here]
\item[Type of Module:] [Record, Library, Abstract Object, or Abstract Data Type]
  [Information to include for leaf modules in the decomposition by secrets tree.]
\end{description}
...
\item[Services:]This module takes in the food that was previously logged by the user from M8 and outputs a display of the information of what it was the user ate and the nutritional details. 
\item[Implemented By:] [Your Program Name Here]
\item[Type of Module:] [Record, Library, Abstract Object, or Abstract Data Type]
  [Information to include for leaf modules in the decomposition by secrets tree.]
\end{description}
...
\item[Services:]The user will provide an input of a food as either a photo or by vocally communicating the name and the module will send it to get processed to identify the food and display the results of the AI generated result.
\item[Implemented By:] [Your Program Name Here]
\item[Type of Module:] [Record, Library, Abstract Object, or Abstract Data Type]
  [Information to include for leaf modules in the decomposition by secrets tree.]
\end{description}
