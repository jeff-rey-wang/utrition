...
\newpage
\section{Navigation Bar Module} \label{Navbar} \wss{Use labels for
cross-referencing}
...
have local scope.}
\newpage
\section{Manual Logging Module} \label{ManualLogging} \wss{Use labels for
cross-referencing}
\wss{You can reference SRS labels, such as R\ref{R_Inputs}.}
\wss{It is also possible to use \LaTeX for hypperlinks to external documents.}
\subsection{Module}
...
have local scope.}
\newpage
\section{Voice Upload Module} \label{VoiceUpload} \wss{Use labels for
cross-referencing}
\wss{You can reference SRS labels, such as R\ref{R_Inputs}.}
\wss{It is also possible to use \LaTeX for hypperlinks to external documents.}
\subsection{Module}
...
\section{MIS of \wss{Backend Communication Module}} \label{Module}
...
\section{MIS of \wss{Image Classification Module}} \label{Module}
...
\wss{tf.compat.v1.train.GradientDescentOptimizer(learning\_rate).minimize(loss): Execute GradientDescentOptimizer and tries to minimize loss by computing the gradients of its trainable variables. Optimizes weights system variable on pass.}

\newpage

\section{MIS of \wss{Input Pre-Processing Module}} \label{Module}
...
\section{MIS of \wss{Training Dataset Module}} \label{Module}
