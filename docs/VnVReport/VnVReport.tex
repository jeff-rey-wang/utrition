...
\begin{document}
	...
	\begin{table}[H]
		...
		\begin{tabular}{|p{3.5cm}|p{6.5cm}|p{4.5cm}|}
			...
			\begin{tabular}[c]{@{}l@{}}one-upload-3\\
				...
				multi-voice-upload-3\end{tabular}                                        
			\\
			\hline
	...
	\begin{table}[H]
		\begin{tabular}{|p{3.5cm}|p{6.5cm}|p{4.5cm}|}
			...
			multi-text-upload-2\\
			multi-text-upload-3\end{tabular} \\ \hline
			...
			voice-upload-10\\
			voice-upload-11\\
			voice-upload-12\end{tabular} \\ \hline
			...
			FR15                     & The user must have the ability to select between uploading food(s) through image, text, or voice.                                                                                                    & \begin{tabular}[c]{@{}l@{}}voice-upload-12\end{tabular} \\ \hline
			
			FR16                     & The system will display the user's most logged food.                                                                                                            & \begin{tabular}[c]{@{}l@{}}\end{tabular} \\ \hline
	...
	\begin{table}[H]
		\begin{tabular}{|p{3.5cm}|p{6.5cm}|p{4.5cm}|}
			...
			\hline
			\textbf{Requirement \#} & \textbf{Description}                                                                                                                                                                  & \textbf{Test ID(s)}                                                                                          \\ \hline
			FR17                     & The system will display the user's total calories consumed for the day.                                                                                                           & \begin{tabular}[c]{@{}l@{}}\end{tabular} \\ \hline
			
			FR18                     & The system will display a summary of the foods consumed and their total calories for each of the past 7 days.                                                                                                            & \begin{tabular}[c]{@{}l@{}}\end{tabular} \\ \hline
			
			FR19                     & The user will be able to access the summary of the foods consumed and their total calories for all days with a food inputted.                                                                                                            & \begin{tabular}[c]{@{}l@{}}\end{tabular} \\ \hline
			...
			home-page-2\\
			profile-page-2\\
			upload-page-2\end{tabular} \\ \hline
