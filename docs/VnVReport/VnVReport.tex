...
\begin{document}
	...
	\begin{enumerate}
		...
		Type: Functional, Unit, Automatic.
	...
	\begin{enumerate}
        ...
        Type: Functional, Unit, Dynamic, Automatic.
...
data.                                                                                                          & \begin{tabular}[c]{@{}l@{}}
	...
	\begin{table}[H]
		...
		\begin{tabular}{|p{2.3cm}|p{2.5cm}|p{6.5cm}|}
			...
			\end{tabular} \\ 
			\hline
			M3 & Upload Page Module &
			\begin{tabular}[c]{@{}l@{}}
				one-upload-1
			\end{tabular} \\                                                    
			\hline
			M4 & Profile Page Module &
			\begin{tabular}[c]{@{}l@{}}
				profile-1\\
				profile-2\\
				profile-3\\
			...
			\end{tabular} \\ 
			\hline
			M6 & Settings Page Module &
			\begin{tabular}[c]{@{}l@{}}
				settings-page-1\\
				settings-page-3
			\end{tabular} \\ 
			\hline
			M7 & Upload Container Module &
			\begin{tabular}[c]{@{}l@{}}
				one-upload-1\\
				voice-upload-4\\
				voice-upload-6
	...
	\begin{table}[H]
		\begin{tabular}{|p{2.3cm}|p{2.68cm}|p{6.5cm}|}
			...
			\end{tabular} \\ 
					...
					\hline
		M16 & Profile Data Calculation Module &
		\begin{tabular}[]{@{}ll@{}}
			profile-1& \ \ \ \ \ \ \ \ \  profile-8\\
			profile-2& \ \ \ \ \ \ \ \ \  profile-9\\
			profile-3& \ \ \ \ \ \ \ \ \  profile-10\\
			profile-4& \ \ \ \ \ \ \ \ \  profile-11\\
			profile-5& \ \ \ \ \ \ \ \ \ profile-12\\
	...
	\section*{Appendix A}
	\subsection*{Informal User Testing After Revision 0 Notes}
	...
	\section*{Appendix B}
	\subsection*{Usability Testing Survey After Revision 1 Notes}
	\subsubsection*{Survey Questions}	
	
	\begin{itemize}
		\item On the landing page of Utrtition, how would you rate the description/instructions on a scale of 1-5 in terms of understandability? 
		\item Have you used an application that can track your daily calorie intake previously?
		\item If you answered yes to the question how would you rate the uniqueness of Utrition in comparison to these applications?
		\item If you answered yes to question two, can you list the applications you are comparing Utrition to?
		\item How would you rank the visuals of Utrition? 
		\item Can you please list parts of Utrition you think make it unique? 
		\item Can you please list parts of Utrition you think make it usable?
		\item Can you please list the parts of Utrition you do not think are usable?
		\item Can you please list parts of Utrition you do not think are unique?
		\item Can you please state what you liked/did not like about the visuals?
	\end{itemize}
	
	\subsubsection*{User One Results}	
	...
	\begin{itemize}
		...
		\item MyFitnessPal
		\item 10
		\item ability to upload food images, voice input, bmi display
		\item task bar, get started button, ability to switch input methods
		\item no complaints, maybe make it easier to launch the application
		\item nutritional information is given in other apps
		\item I liked the colour scheme, made it seem like using Utrition was healthy with the green visuals. Pictures chosen were pretty
	\end{itemize}
	
	\subsubsection*{User Two Results}	
	...
	\begin{itemize}
		...
		\item none
		\item 10
		\item The voice to text is a very cool feature. I also like the personalized recommended calories
		\item The multiple input methods give me lots of choice for any situation I am in
		\item It would be better if you could take a picture instead of needing to download it
		\item The calorie summary is something that most other health tracking apps have
		\item All the colours were very complementary and directed my attention to important sections.
	\end{itemize}
	
		\subsubsection*{User Three Results}	
	...
	\begin{itemize}
		...
		\item my fitness pal
		\item 8
		\item I like the multiple types of uploading
		\item I like the multiple types of uploading
		\item NA
		\item calorie counting aspect
		\item visuals and font are excellent, needs more consistent colour scheme
	\end{itemize}
	
	\subsubsection*{User Four Results}	
	...
	\begin{itemize}
		...
		\item na
		\item 8
		\item Inputting foods in multiple different ways
		\item Clear user interface with intuitive navigation, few settings hidden behind menus
		\item It can be hard to navigate to the food entries of a specific day in the past if I have many entries 
		\item BMI, graph representation of nutrition, nutrient counting
		\item I like the consistent colour theme!
	\end{itemize}
